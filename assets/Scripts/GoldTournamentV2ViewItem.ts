...
@ccclass('GoldTournamentV2ViewItem')
export class GoldTournamentV2ViewItem extends Component {
    ...
    async refreshRankData(data: any) {
        this.headSp!.spriteFrame = await AvatarCfg.Instance.loadHeadSpriteframe(data.head);
        ...
        const reward = GoldRankRewardV2Cfg.Instance.getRewardById(data.rank);
        if (reward) {
